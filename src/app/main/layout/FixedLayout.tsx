...
import { HeaderLayout } from '@/app/header/HeaderLayout';
...
s
    ...
    <div className='flex flex-col'>
      ...
      <div className={`flex z-10 transition-all ${delta ? "fixed top-0  opacity-90" : "hidden"} duration-400 bg-white w-100` }>
      <MainNav/>
